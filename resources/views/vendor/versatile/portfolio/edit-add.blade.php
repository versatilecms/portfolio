...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('versatile.portfolio.update', $dataTypeContent->id) }}@else{{ route('versatile.portfolio.store') }}@endif" method="POST" enctype="multipart/form-data">
            @php
                ...
                <div class="col-md-8">
                    ...
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                            {!! form_fields($dataTypeRows, $dataTypeContent, ['title', 'body', 'excerpt', 'tags', 'testimonial', 'testimonial_author']) !!}
                        </div>
                    </div>
